...
%%% ----------------------------------------------------------------------------
\section{Indirect Gradient Analysis}
\begin{frame}[plain]{}
\begin{center}
  \Huge \color{title} Indirect Gradient Analysis   \\
  \vspace{4em}
  \normalsize
...
%%% ----------------------------------------------------------------------------
\section{Direct Gradient Analysis}
\begin{frame}[plain]{}
\begin{center}
  \Huge \color{title} Direct Gradient Analysis
\end{center}
\end{frame}
...
\subsection{}
\begin{frame}
\frametitle{Direct Gradient Analysis}
\begin{columns}
  \begin{column}{0.4\textwidth}
  \begin{itemize}
